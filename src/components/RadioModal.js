...
export default class RadioModal extends Component {
	...
	createInner(child, index, props) {
		...
		const contents = props ? child[this.props.options.content] : child.props.content;
	...
	render() {
		...
		return (
			<TouchableHighlight
				...
				style={[ this.props.initStyle]}
				onPress={this.click.bind(this, this.props.value, this.props.child)}>
				<View >
					<View style={{padding:10,flexDirection: 'row', alignItems: 'center' }}>
						{this.props.disabled && !this.props.hightlight && <Image source={imgUrlNone} style={[{ width: 15, height: 15, marginRight: 7 }, this.props.imageStyle]} />}
						{this.props.disabled && this.props.hightlight && <Image source={imgUrl} style={[{ width: 15, height: 15, marginRight: 7 }, this.props.imageStyle]} />}
						{!this.props.disabled && <Image source={imgUrl} style={[{ width: 20, height: 20, marginRight: 7 }, this.props.imageStyle]} />}
						<Text style={[{ color: this.props.disabled ? this.props.noneColor || '#dfdfdf' : this.props.txtColor || '#414141', width: width / 4, marginRight: width / 4, marginLeft: 10, fontSize: 16 }, this.props.textStyle]}>{this.props.child}</Text>
					</View>
